...
# load dataset
train_dataset = PPI(root='./dataset', split="train",transform=T.NormalizeFeatures())
val_dataset = PPI(root='./dataset', split="val",transform=T.NormalizeFeatures())
test_dataset = PPI(root='./dataset', split="test",transform=T.NormalizeFeatures())
...
if args.train:
    ...
    for epoch in range(1, args.n_epoch + 1):
        ...
        writer.add_scalars('Avg_Loss',{"Train":avg_train_loss,"Val":avg_val_loss},epoch)
        writer.add_scalars('Avg_Micro_F1',{"Train":avg_train_micro_f1,"Val":avg_val_micro_f1},epoch)
